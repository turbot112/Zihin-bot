...
def start(update: Update, context: CallbackContext):
    update.message.reply_text("ZihinBot 4.0'a hoş geldin! Komutlar için /yardim yazabilirsin.")
...
def guncelle(update: Update, context: CallbackContext):
    ...
    log_event("Güncelleme komutu çalıştı.")

def yenilik(update: Update, context: CallbackContext):
    metin = """Planlanan yenilikler:
